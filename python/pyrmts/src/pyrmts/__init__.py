...
__all__ = [
    ...
    'validate_key_template', 'content_hash', 'hash_width', 'put_shard', 'put_shard_slot', 'slot_values', 'listed_slots', 'legacy_template', 'slot_of_any', 'ShardWrite', 'KeyResolver', 'TemplateResolver',
